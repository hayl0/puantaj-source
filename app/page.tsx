          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            ...
            >
              <div className="relative rounded-xl bg-[#0B0F19] border border-white/10 shadow-2xl overflow-hidden transform rotate-x-12 hover:rotate-x-0 transition-transform duration-1000 ease-out group">
                ...
                {/* Mockup Content */}
                <div className="flex h-[500px] bg-[#0B0F19]">
                   {/* Sidebar */}
                   <div className="hidden md:flex w-56 flex-col border-r border-white/5 p-4 space-y-2 bg-[#0B0F19]">
                      ...
                      <div className="px-3 py-2 rounded-lg text-slate-400 hover:bg-white/5 flex items-center gap-3 text-sm font-medium transition-colors cursor-pointer group/item">
                        <Settings className="w-4 h-4 group-hover/item:text-slate-200 transition-colors" />
                        Ayarlar
                      </div>
                      ...
                      <div className="mt-4 p-3 rounded-xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20">
                        ...
                        <div className="text-xs text-slate-400 mb-2">Hesabınız aktif ve güvende.</div>
                      </div>
                   </div>
                      ...
                      <div className="grid grid-cols-4 gap-4 mb-8">
                        ...
                        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-indigo-500/30 transition-all group/card hover:-translate-y-1">
                          <div className="flex justify-between items-start mb-4">
                            <div className="p-2.5 rounded-xl bg-indigo-500/10 text-indigo-400 group-hover/card:bg-indigo-500 group-hover/card:text-white transition-colors">
                            ...
                            <span className="flex items-center gap-1 text-xs text-emerald-400 font-medium bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/20">
                              +12% <ChevronRight className="w-2 h-2 rotate-90" />
                            </span>
                          </div>
                          <div className="text-3xl font-bold text-white mb-1">24</div>
                          <div className="text-xs text-slate-500 font-medium">Aktif Personel</div>
                        </div>

                        {/* Stats Card 2 */}
                        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-violet-500/30 transition-all group/card hover:-translate-y-1">
                          <div className="flex justify-between items-start mb-4">
                            <div className="p-2.5 rounded-xl bg-violet-500/10 text-violet-400 group-hover/card:bg-violet-500 group-hover/card:text-white transition-colors">
                              <Clock className="w-5 h-5" />
                            </div>
                            <span className="flex items-center gap-1 text-xs text-slate-400 font-medium bg-slate-500/10 px-2 py-0.5 rounded-full border border-slate-500/20">
                              Stabil
                            </span>
                          </div>
                          <div className="text-3xl font-bold text-white mb-1">168s</div>
                          <div className="text-xs text-slate-500 font-medium">Toplam Mesai</div>
                        </div>

                        {/* Stats Card 3 */}
                        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-pink-500/30 transition-all group/card hover:-translate-y-1">
                          <div className="flex justify-between items-start mb-4">
                            <div className="p-2.5 rounded-xl bg-pink-500/10 text-pink-400 group-hover/card:bg-pink-500 group-hover/card:text-white transition-colors">
                              <Wallet className="w-5 h-5" />
                            </div>
                            <span className="flex items-center gap-1 text-xs text-emerald-400 font-medium bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/20">
                              +5% <ChevronRight className="w-2 h-2 rotate-90" />
                            </span>
                          </div>
                          <div className="text-3xl font-bold text-white mb-1">₺42.5K</div>
                          <div className="text-xs text-slate-500 font-medium">Tahmini Gider</div>
                        </div>

                         {/* Stats Card 4 */}
                         <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-amber-500/30 transition-all group/card hover:-translate-y-1">
                          <div className="flex justify-between items-start mb-4">
                            <div className="p-2.5 rounded-xl bg-amber-500/10 text-amber-400 group-hover/card:bg-amber-500 group-hover/card:text-white transition-colors">
                          ...
                          <div className="text-xs text-slate-500 font-medium">Memnuniyet</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-6 h-full">
                        ...
                        <div className="col-span-2 rounded-2xl bg-white/[0.02] border border-white/5 p-6 relative overflow-hidden">
                           <div className="flex items-center justify-between mb-6">
                             <div className="flex items-center gap-3">
                               ...
                               <div>
                                 <div className="text-sm font-bold text-white">Haftalık Katılım</div>
                                 <div className="text-[10px] text-slate-500">Son 7 günlük personel devamlılığı</div>
                               </div>
                             </div>
                             <MoreHorizontal className="w-4 h-4 text-slate-600 cursor-pointer hover:text-white transition-colors" />
                           </div>
                           ...
                           <div className="relative h-48 w-full">
                              ...
                              {/* Bars */}
                              <div className="absolute inset-0 flex items-end justify-between px-4 pt-4 pb-0 z-10">
                                {['Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt', 'Paz'].map((day, i) => {
                                  const heights = [40, 75, 55, 85, 60, 30, 20];
                                  const h = heights[i];
                                  return (
                                    <div key={day} className="flex flex-col items-center gap-2 group/bar w-full">
                                      <div className="relative w-full max-w-[40px] h-full flex items-end group-hover/bar:scale-105 transition-transform duration-300">
                                         <motion.div 
                                          initial={{ height: 0 }}
                                          whileInView={{ height: `${h}%` }}
                                          transition={{ duration: 1, delay: i * 0.1 }}
                                          viewport={{ once: true }}
                                          className="w-full bg-gradient-to-t from-indigo-600/80 to-indigo-400/80 rounded-t-sm group-hover/bar:from-indigo-500 group-hover/bar:to-indigo-300 transition-colors shadow-[0_0_20px_rgba(99,102,241,0.3)]"
                                         />
                                         <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-2 rounded opacity-0 group-hover/bar:opacity-100 transition-opacity whitespace-nowrap z-20 pointer-events-none">
                                           %{h} Katılım
                                         </div>
                                      </div>
                                      <span className="text-[10px] font-medium text-slate-500 uppercase tracking-wider">{day}</span>
                                    </div>
                                  );
                                })}
                              </div>
                        ...
                        <div className="col-span-1 rounded-2xl bg-white/[0.02] border border-white/5 p-6 flex flex-col">
                          ...
                          <div className="space-y-4 overflow-y-auto pr-2 custom-scrollbar">
                            {[
                              { name: 'Ahmet Yılmaz', action: 'Giriş Yaptı', time: '08:30', color: 'text-emerald-400', bg: 'bg-emerald-500/10', icon: 'G' },
                              { name: 'Selin Kaya', action: 'İzin Talebi', time: '09:15', color: 'text-amber-400', bg: 'bg-amber-500/10', icon: 'İ' },
                              { name: 'Mehmet Demir', action: 'Mola Başladı', time: '12:00', color: 'text-blue-400', bg: 'bg-blue-500/10', icon: 'M' },
                              { name: 'Ayşe Yıldız', action: 'Çıkış Yaptı', time: '18:00', color: 'text-slate-400', bg: 'bg-slate-500/10', icon: 'Ç' },
                              { name: 'Can Öztürk', action: 'Fazla Mesai', time: '19:30', color: 'text-purple-400', bg: 'bg-purple-500/10', icon: 'F' },
                            ].map((item, i) => (
                              <div key={i} className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group/list-item">
                                <div className={`w-8 h-8 rounded-full ${item.bg} flex items-center justify-center text-xs font-bold ${item.color} border border-white/5 group-hover/list-item:scale-110 transition-transform`}>
                                  {item.icon}
                                </div>
                                <div className="flex-1 min-w-0">
                                  <div className="text-xs font-bold text-slate-300 truncate group-hover/list-item:text-white transition-colors">{item.name}</div>
                                  <div className="text-[10px] text-slate-500 flex items-center gap-1">
                                    <span className={`w-1.5 h-1.5 rounded-full ${item.color.replace('text', 'bg')}`}></span>
                                    {item.action}
                                  </div>
                                </div>
                                <div className="text-[10px] font-medium text-slate-600 group-hover/list-item:text-slate-400 transition-colors">{item.time}</div>
                              </div>
                            ))}
                          </div>
                        </div>
